...
export function Sidebar() {
  ...
  const handleTabKeyDown = (event: React.KeyboardEvent, tabName: typeof activeTab) => {
    ...
    <Card className="h-full rounded-none border-t-0 border-l-0 border-b-0 bg-background flex flex-col" data-tutorial-id="sidebar-card">
      ...
      <div className="border-b flex-shrink-0">
        <div className="flex" role="tablist" aria-label="Sidebar navigation">
          ...
          <button
            role="tab"
            data-tutorial-id="attachments-tab"
      ...
      <div className="flex-1 overflow-y-auto min-h-0">
        {activeTab === 'policies' && (
          <div
            ...
            className="p-3 sm:p-4 space-y-4 min-h-0"
          >
            <PolicyTab selectedNode={selectedNode} />
          </div>
        )}
        ...
        {activeTab === 'attachments' && (
          ...
          >
            <AttachmentsTab selectedNode={selectedNode} />
          </div>
        )}
      </div>
      ...
      <div className="flex-shrink-0 p-2">
        ...
        <p className="text-xs text-center text-muted-foreground">
          Built by{" "}
          <a 
            href="https://www.linkedin.com/in/lukehau/" 
            target="_blank" 
            rel="noopener noreferrer"
