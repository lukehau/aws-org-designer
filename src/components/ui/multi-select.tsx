...
interface MultiSelectProps
	...
	/**
	 * If true, enables smart truncation that adapts to available container space.
	 * Optional, defaults to false.
	 */
	smartTruncate?: boolean;

	/**
	 * Policy type for PolicyBadge styling when usePolicyBadge is true.
	 * Optional, only used when usePolicyBadge is enabled.
	 */
	policyType?: 'scp' | 'rcp';

	/**
	 * If true, uses PolicyBadge component instead of regular Badge.
	 * Optional, defaults to false.
	 */
	usePolicyBadge?: boolean;
}
													...
													<PolicyBadge
														...
														<span
															className={cn(
																...
																smartTruncate && "truncate flex-1 min-w-0"
															)}
															title={smartTruncate ? option.label : undefined}>
															{option.label}
														</span>
													</PolicyBadge>
												);
